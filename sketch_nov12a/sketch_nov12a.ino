...
void loop(){
  ...
  if (joy_xaxis > 10){
     analogWrite(MOTOR_B_0, map(joy_yaxis, 0, 533, 0, 255));
     analogWrite(MOTOR_B_1, 0);

     analogWrite(MOTOR_A_0, map(joy_yaxis, 0, 533, 0, 255));
     analogWrite(MOTOR_A_1, 0);

     analogWrite(MOTOR_C_0, map(joy_yaxis, 0, 533, 0, 255));
     analogWrite(MOTOR_C_1, 0);

     analogWrite(MOTOR_D_0, map(joy_yaxis, 0, 533, 0, 255));
     analogWrite(MOTOR_D_1, 0);
     
  } else if (joy_xaxis < -10){
     analogWrite(MOTOR_B_0, 0);
     analogWrite(MOTOR_B_1, map(joy_yaxis * -1, 0, 533, 0, 255));

     analogWrite(MOTOR_A_0, 0);
     analogWrite(MOTOR_A_1, map(joy_yaxis * -1, 0, 533, 0, 255));

     analogWrite(MOTOR_C_0, 0);
     analogWrite(MOTOR_C_1, map(joy_yaxis * -1, 0, 533, 0, 255));

     analogWrite(MOTOR_D_0, 0);
     analogWrite(MOTOR_D_1, map(joy_yaxis * -1, 0, 533, 0, 255));
  } else {
     analogWrite(MOTOR_B_0, 0);
     analogWrite(MOTOR_B_1, 0);
